...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public static class MonoBehaviourEndOfFrameExtensions
    {
        ...
        public static void RegisterEndOfFrameCallback(this MonoBehaviour monoBehaviour, Action callback)
        {
        ...
        public static void UnregisterEndOfFrameCallback(this MonoBehaviour monoBehaviour)
        {
            if (!_routines.ContainsKey(monoBehaviour))
            {
