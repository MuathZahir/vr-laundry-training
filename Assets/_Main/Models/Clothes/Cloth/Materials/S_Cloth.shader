...
Shader "S_Cloth"
{
	Properties
	{
		...
		[ASEBegin]_T_M_1_Cloth_AlbedoTransparency("T_M_1_Cloth_AlbedoTransparency", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _T_M_Dirt_Roughness_ST;
			float4 _TextureSample0_ST;
			float _StainsOpacity;
			float _DirtOpacity;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_T_M_1_Cloth_MetallicSmoothness = IN.ase_texcoord8.xy * _T_M_1_Cloth_MetallicSmoothness_ST.xy + _T_M_1_Cloth_MetallicSmoothness_ST.zw;
				float4 tex2DNode11 = tex2D( _T_M_1_Cloth_MetallicSmoothness, uv_T_M_1_Cloth_MetallicSmoothness );
				
				float4 temp_cast_2 = (tex2DNode11.a).xxxx;
				float2 uv_T_M_Dirt_Roughness = IN.ase_texcoord8.xy * _T_M_Dirt_Roughness_ST.xy + _T_M_Dirt_Roughness_ST.zw;
				float4 lerpResult36 = lerp( temp_cast_2 , ( 1.0 - tex2D( _T_M_Dirt_Roughness, uv_T_M_Dirt_Roughness ) ) , ( _StainsOpacity * tex2DNode14 ));
				float2 uv_TextureSample0 = IN.ase_texcoord8.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float4 lerpResult37 = lerp( lerpResult36 , ( 1.0 - tex2D( _TextureSample0, uv_TextureSample0 ) ) , ( _DirtOpacity * tex2DNode24 ));
				

				float3 BaseColor = lerpResult23.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _T_M_Cloth_1_Normal, uv_T_M_Cloth_1_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode11.r;
				float Smoothness = lerpResult37.r;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_T_M_Cloth_1_Normal = IN.ase_texcoord4.xy * _T_M_Cloth_1_Normal_ST.xy + _T_M_Cloth_1_Normal_ST.zw;
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2789.606,2.877002;Inherit;False;Property;_StainsOpacity;Stains Opacity;3;0;Create;True;0;0;0;False;0;False;0.9;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;38;88.46002,1355.544;Inherit;True;Property;_T_M_Cloth_1_Normal;T_M_Cloth_1_Normal;2;0;Create;True;0;0;0;False;0;False;-1;9b21b0ac6f65ba1489ebefce07e5c8d9;f5b97cc420b27c74983b45ac2b2bd055;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;40;-724.6402,-730.093;Inherit;False;Property;_DirtColor;Dirt Color;6;0;Create;True;0;0;0;False;0;False;0.3882353,0.3490196,0.3215686,1;0.3882352,0.3490195,0.3215685,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;39;-1148.811,-741.6833;Inherit;False;Property;_StainColor;Stain Color;4;0;Create;True;0;0;0;False;0;False;0.2901961,0.2941177,0.1764706,1;0.3652055,0.3679245,0.2863563,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-1185.253,-531.0518;Inherit;True;Property;_T_M_Stains_AlbedoTransparency;T_M_Stains_AlbedoTransparency;7;0;Create;True;0;0;0;False;0;False;-1;b33fbad0524e0c741b79d195502690ae;b33fbad0524e0c741b79d195502690ae;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1351.655,702.6579;Inherit;True;Property;_T_M_1_Cloth_AlbedoTransparency;T_M_1_Cloth_AlbedoTransparency;0;0;Create;True;0;0;0;False;0;False;-1;None;abff160957991ba4a95cfacfedfa1ef2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-2832.753,289.0631;Inherit;True;Property;_Mask_2;Mask_2;7;0;Create;True;0;0;0;False;0;False;-1;eccc9d1b5df64be438b89d19db61f4da;eccc9d1b5df64be438b89d19db61f4da;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-2793.754,-306.4803;Inherit;True;Property;_Mask_1;Mask_1;7;0;Create;True;0;0;0;False;0;False;-1;eef711d0480781043959382cc1d47707;eef711d0480781043959382cc1d47707;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1868.44,-328.0117;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=77358AC3D79B41CE4815E5AACF016BB66BB8FF6A