...
Shader "M_Master_2"
{
	Properties
	{
		...
		[ASEEnd]_Master_2_metallic_Smoothness("Master_2_metallic_Smoothness", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_cast_0 = (( -0.03 + (WorldPosition.y*1.0 + -1.29) )).xxxx;
				float4 temp_output_20_0 = ( 1.0 - CalculateContrast(-0.6,temp_cast_0) );
				float2 uv_Master_2_diffuse = IN.ase_texcoord8.xy * _Master_2_diffuse_ST.xy + _Master_2_diffuse_ST.zw;
				float4 blendOpSrc14 = temp_output_20_0;
				float4 blendOpDest14 = tex2D( _Master_2_diffuse, uv_Master_2_diffuse );
				float4 blendOpSrc26 = temp_output_20_0;
				float4 blendOpDest26 = ( saturate( ( blendOpSrc14 * blendOpDest14 ) ));
				float4 lerpBlendMode26 = lerp(blendOpDest26,( 1.0 - ( 1.0 - blendOpSrc26 ) * ( 1.0 - blendOpDest26 ) ),0.11);
				float4 Base_Color29 = ( ( ( 1.0 - WorldNormal.y ) + 0.79 ) * ( saturate( lerpBlendMode26 )) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 temp_cast_0 = (( -0.03 + (WorldPosition.y*1.0 + -1.29) )).xxxx;
				float4 temp_output_20_0 = ( 1.0 - CalculateContrast(-0.6,temp_cast_0) );
				float2 uv_Master_2_diffuse = IN.ase_texcoord5.xy * _Master_2_diffuse_ST.xy + _Master_2_diffuse_ST.zw;
				float4 blendOpSrc14 = temp_output_20_0;
				float4 blendOpDest14 = tex2D( _Master_2_diffuse, uv_Master_2_diffuse );
				float4 blendOpSrc26 = temp_output_20_0;
				float4 blendOpDest26 = ( saturate( ( blendOpSrc14 * blendOpDest14 ) ));
				float4 lerpBlendMode26 = lerp(blendOpDest26,( 1.0 - ( 1.0 - blendOpSrc26 ) * ( 1.0 - blendOpDest26 ) ),0.11);
				float4 Base_Color29 = ( ( ( 1.0 - ase_worldNormal.y ) + 0.79 ) * ( saturate( lerpBlendMode26 )) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 temp_cast_0 = (( -0.03 + (WorldPosition.y*1.0 + -1.29) )).xxxx;
				float4 temp_output_20_0 = ( 1.0 - CalculateContrast(-0.6,temp_cast_0) );
				float2 uv_Master_2_diffuse = IN.ase_texcoord3.xy * _Master_2_diffuse_ST.xy + _Master_2_diffuse_ST.zw;
				float4 blendOpSrc14 = temp_output_20_0;
				float4 blendOpDest14 = tex2D( _Master_2_diffuse, uv_Master_2_diffuse );
				float4 blendOpSrc26 = temp_output_20_0;
				float4 blendOpDest26 = ( saturate( ( blendOpSrc14 * blendOpDest14 ) ));
...
/*ASEBEGIN
Version=19106
Node;AmplifyShaderEditor.SamplerNode;10;-686.2,-175.7;Inherit;True;Property;_Master_2_diffuse;Master_2_diffuse;0;0;Create;True;0;0;0;False;0;False;-1;914289dc38d8b0c46b876ee055c5831b;914289dc38d8b0c46b876ee055c5831b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;13;-1046.441,-461.4908;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.OneMinusNode;20;73.93297,-642.525;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;24;-1512.726,-162.3496;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;22;-1229.351,-166.2104;Inherit;False;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;5.29;False;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;14;478.3018,-447.3691;Inherit;True;Multiply;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1.96;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleContrastOpNode;15;-244.3882,-635.6982;Inherit;True;2;1;COLOR;0,0,0,0;False;0;FLOAT;-0.6;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;27;791.6446,353.3705;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-577.3882,-631.6982;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;28;-767.9697,-460.9299;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;-1.29;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;2006,-41;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;M_Master_2;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-1008.523,-659.6982;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;-0.03;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;30;1654.642,-37.15558;Inherit;False;29;Base_Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;26;862.4275,-552.2178;Inherit;True;Screen;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.11;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldSpaceViewDirHlpNode;35;-181.3846,-146.9662;Inherit;True;1;0;FLOAT4;0,0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RegisterLocalVarNode;29;1781.29,-557.9942;Inherit;False;Base_Color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;34;775.034,-253.7492;Inherit;True;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;1480.842,-407.8981;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;11;-578.991,1076.854;Inherit;True;Property;_Master_2_normal;Master_2_normal;1;0;Create;True;0;0;0;False;0;False;-1;08a9597f417d8e143b55043ee31d5df9;08a9597f417d8e143b55043ee31d5df9;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-604.991,788.8546;Inherit;True;Property;_Master_2_metallic_Smoothness;Master_2_metallic_Smoothness;2;0;Create;True;0;0;0;False;0;False;-1;c66527c22cef5d24cb480c5ad687c31f;c66527c22cef5d24cb480c5ad687c31f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;37;1044.491,-206.5927;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;1286.07,-202.8911;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.79;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=EC37563013D04E2BE5415F20B7C97A8E42AADCA7