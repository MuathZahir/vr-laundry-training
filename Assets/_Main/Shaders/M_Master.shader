...
Shader "M_Master_2"
{
	Properties
	{
		...
		[ASEBegin]_Master_2_diffuse("Master_2_diffuse", 2D) = "white" {}
		_Master_2_normal("Master_2_normal", 2D) = "bump" {}
		_Master_2_metallic_Smoothness("Master_2_metallic_Smoothness", 2D) = "white" {}
		[ASEEnd]_Master_emissive("Master_emissive", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Master_2_diffuse_ST;
			float4 _Master_2_normal_ST;
			float4 _Master_emissive_ST;
			float4 _Master_2_metallic_Smoothness_ST;
			...
			sampler2D _Master_2_diffuse;
			sampler2D _Master_2_normal;
			sampler2D _Master_emissive;
			sampler2D _Master_2_metallic_Smoothness;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Master_2_diffuse = IN.ase_texcoord8.xy * _Master_2_diffuse_ST.xy + _Master_2_diffuse_ST.zw;
				float4 tex2DNode10 = tex2D( _Master_2_diffuse, uv_Master_2_diffuse );
				float4 color64 = IsGammaSpace() ? float4(0.8113208,0.540894,0.1415984,0) : float4(0.6231937,0.2538632,0.01773316,0);
				float4 temp_cast_0 = (( (( 1.0 - WorldNormal.y )*1.0 + -0.08) + 0.01 )).xxxx;
				float4 blendOpSrc59 = color64;
				float4 blendOpDest59 = temp_cast_0;
				float3 temp_cast_1 = ((( 1.0 - WorldPosition.y )*1.0 + 0.89)).xxx;
				float grayscale52 = Luminance(temp_cast_1);
				float4 lerpResult54 = lerp( tex2DNode10 , ( ( saturate( (( blendOpDest59 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest59 ) * ( 1.0 - blendOpSrc59 ) ) : ( 2.0 * blendOpDest59 * blendOpSrc59 ) ) )) * tex2DNode10 ) , ( 1.0 - grayscale52 ));
				float4 lerpResult56 = lerp( lerpResult54 , tex2DNode10 , 0.79);
				float4 Base_Color29 = lerpResult56;
				
				float2 uv_Master_2_normal = IN.ase_texcoord8.xy * _Master_2_normal_ST.xy + _Master_2_normal_ST.zw;
				
				float2 uv_Master_emissive = IN.ase_texcoord8.xy * _Master_emissive_ST.xy + _Master_emissive_ST.zw;
				
				float2 uv_Master_2_metallic_Smoothness = IN.ase_texcoord8.xy * _Master_2_metallic_Smoothness_ST.xy + _Master_2_metallic_Smoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _Master_2_metallic_Smoothness, uv_Master_2_metallic_Smoothness );
				

				float3 BaseColor = Base_Color29.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Master_2_normal, uv_Master_2_normal ), 1.0f );
				float3 Emission = tex2D( _Master_emissive, uv_Master_emissive ).rgb;
				float3 Specular = 0.5;
				float Metallic = tex2DNode12.r;
				float Smoothness = ( tex2DNode12.a + -0.18 );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Master_2_diffuse = IN.ase_texcoord4.xy * _Master_2_diffuse_ST.xy + _Master_2_diffuse_ST.zw;
				float4 tex2DNode10 = tex2D( _Master_2_diffuse, uv_Master_2_diffuse );
				float4 color64 = IsGammaSpace() ? float4(0.8113208,0.540894,0.1415984,0) : float4(0.6231937,0.2538632,0.01773316,0);
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float4 temp_cast_0 = (( (( 1.0 - ase_worldNormal.y )*1.0 + -0.08) + 0.01 )).xxxx;
				float4 blendOpSrc59 = color64;
				float4 blendOpDest59 = temp_cast_0;
				float3 temp_cast_1 = ((( 1.0 - WorldPosition.y )*1.0 + 0.89)).xxx;
				float grayscale52 = Luminance(temp_cast_1);
				...
				float2 uv_Master_emissive = IN.ase_texcoord4.xy * _Master_emissive_ST.xy + _Master_emissive_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Master_2_diffuse = IN.ase_texcoord2.xy * _Master_2_diffuse_ST.xy + _Master_2_diffuse_ST.zw;
				float4 tex2DNode10 = tex2D( _Master_2_diffuse, uv_Master_2_diffuse );
				float4 color64 = IsGammaSpace() ? float4(0.8113208,0.540894,0.1415984,0) : float4(0.6231937,0.2538632,0.01773316,0);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Master_2_normal = IN.ase_texcoord4.xy * _Master_2_normal_ST.xy + _Master_2_normal_ST.zw;
...
Node;AmplifyShaderEditor.GetLocalVarNode;30;1654.642,-37.15558;Inherit;False;29;Base_Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;34;407.7386,-178.7382;Inherit;True;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;10;429.1019,-553.7684;Inherit;True;Property;_Master_2_diffuse;Master_2_diffuse;0;0;Create;True;0;0;0;False;0;False;-1;156370006bdc3f7498f37313c903663b;914289dc38d8b0c46b876ee055c5831b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;37;659.9318,-138.2218;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;49;1052.02,-837.3718;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.OneMinusNode;50;1384.771,-817.1392;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;48;869.6485,-145.9264;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;-0.08;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;1149.747,-158.517;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;56;3813.054,-946.8557;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;54;3172.56,-660.5594;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;57;3392.725,-1087.591;Inherit;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;0;False;0;False;0.79;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;51;1620.523,-823.783;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0.89;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;53;2688.433,-847.3624;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;52;2120.891,-869.8833;Inherit;True;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;2171.378,-417.0176;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;64;1232.11,-382.6748;Inherit;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0.8113208,0.540894,0.1415984,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BlendOpsNode;59;1861.648,-258.9298;Inherit;True;Overlay;True;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;29;4460.533,-666.4023;Inherit;True;Base_Color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;11;3228.098,681.5717;Inherit;True;Property;_Master_2_normal;Master_2_normal;1;0;Create;True;0;0;0;False;0;False;-1;c6a5565e9d8ebb941a083dbf78ec819e;08a9597f417d8e143b55043ee31d5df9;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;65;4277.692,534.3873;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;-0.18;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;3305.964,254.1072;Inherit;True;Property;_Master_2_metallic_Smoothness;Master_2_metallic_Smoothness;2;0;Create;True;0;0;0;False;0;False;-1;f7e4b286aac570349a43bc41dc1fb971;c66527c22cef5d24cb480c5ad687c31f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;4758.799,36.93553;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;M_Master_2;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;41;Workflow;1;638241033538742311;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;1;0;Transmission;0;638241003146407973;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;39;3490.075,-147.7379;Inherit;True;Property;_Master_emissive;Master_emissive;3;0;Create;True;0;0;0;False;0;False;-1;726345606bf66f24596363622bf44d7e;726345606bf66f24596363622bf44d7e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=17212E90C820766DFFAE5CFE66E516EAD93851EE