...
Shader "Wahing_Machine"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_T_M_Washing_2_Machine_AlbedoTransparency("T_M_Washing_2_Machine_AlbedoTransparency", 2D) = "white" {}
		_T_M_Washing_2_Machine_MetallicSmoothness("T_M_Washing_2_Machine_MetallicSmoothness", 2D) = "white" {}
		_T_M_Washing_2_Machine_Normal("T_M_Washing_2_Machine_Normal", 2D) = "bump" {}
		[ASEEnd]_T_M_Washing_2_Machine_Opacity("T_M_Washing_2_Machine_Opacity", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _T_M_Washing_2_Machine_AlbedoTransparency_ST;
			float4 _T_M_Washing_2_Machine_Normal_ST;
			float4 _T_M_Washing_2_Machine_MetallicSmoothness_ST;
			float4 _T_M_Washing_2_Machine_Opacity_ST;
			...
			sampler2D _T_M_Washing_2_Machine_AlbedoTransparency;
			sampler2D _T_M_Washing_2_Machine_Normal;
			sampler2D _T_M_Washing_2_Machine_MetallicSmoothness;
			sampler2D _T_M_Washing_2_Machine_Opacity;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_T_M_Washing_2_Machine_AlbedoTransparency = IN.ase_texcoord8.xy * _T_M_Washing_2_Machine_AlbedoTransparency_ST.xy + _T_M_Washing_2_Machine_AlbedoTransparency_ST.zw;
				
				float2 uv_T_M_Washing_2_Machine_Normal = IN.ase_texcoord8.xy * _T_M_Washing_2_Machine_Normal_ST.xy + _T_M_Washing_2_Machine_Normal_ST.zw;
				
				float2 uv_T_M_Washing_2_Machine_MetallicSmoothness = IN.ase_texcoord8.xy * _T_M_Washing_2_Machine_MetallicSmoothness_ST.xy + _T_M_Washing_2_Machine_MetallicSmoothness_ST.zw;
				float4 tex2DNode11 = tex2D( _T_M_Washing_2_Machine_MetallicSmoothness, uv_T_M_Washing_2_Machine_MetallicSmoothness );
				
				float2 uv_T_M_Washing_2_Machine_Opacity = IN.ase_texcoord8.xy * _T_M_Washing_2_Machine_Opacity_ST.xy + _T_M_Washing_2_Machine_Opacity_ST.zw;
				

				float3 BaseColor = tex2D( _T_M_Washing_2_Machine_AlbedoTransparency, uv_T_M_Washing_2_Machine_AlbedoTransparency ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _T_M_Washing_2_Machine_Normal, uv_T_M_Washing_2_Machine_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode11.r;
				float Smoothness = tex2DNode11.a;
				float Occlusion = 1;
				float Alpha = tex2D( _T_M_Washing_2_Machine_Opacity, uv_T_M_Washing_2_Machine_Opacity ).r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_T_M_Washing_2_Machine_Opacity = IN.ase_texcoord2.xy * _T_M_Washing_2_Machine_Opacity_ST.xy + _T_M_Washing_2_Machine_Opacity_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_T_M_Washing_2_Machine_AlbedoTransparency = IN.ase_texcoord4.xy * _T_M_Washing_2_Machine_AlbedoTransparency_ST.xy + _T_M_Washing_2_Machine_AlbedoTransparency_ST.zw;
				
				float2 uv_T_M_Washing_2_Machine_Opacity = IN.ase_texcoord4.xy * _T_M_Washing_2_Machine_Opacity_ST.xy + _T_M_Washing_2_Machine_Opacity_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_T_M_Washing_2_Machine_AlbedoTransparency = IN.ase_texcoord2.xy * _T_M_Washing_2_Machine_AlbedoTransparency_ST.xy + _T_M_Washing_2_Machine_AlbedoTransparency_ST.zw;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_T_M_Washing_2_Machine_Normal = IN.ase_texcoord4.xy * _T_M_Washing_2_Machine_Normal_ST.xy + _T_M_Washing_2_Machine_Normal_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_T_M_Washing_2_Machine_Opacity = IN.ase_texcoord.xy * _T_M_Washing_2_Machine_Opacity_ST.xy + _T_M_Washing_2_Machine_Opacity_ST.zw;
				

				surfaceDescription.Alpha = tex2D( _T_M_Washing_2_Machine_Opacity, uv_T_M_Washing_2_Machine_Opacity ).r;
...
Node;AmplifyShaderEditor.SamplerNode;12;-687.5,268;Inherit;True;Property;_T_M_Washing_2_Machine_Normal;T_M_Washing_2_Machine_Normal;2;0;Create;True;0;0;0;False;0;False;-1;de02bc2be30da474bb8e937b70032bfb;de02bc2be30da474bb8e937b70032bfb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-691.5,472;Inherit;True;Property;_T_M_Washing_2_Machine_Opacity;T_M_Washing_2_Machine_Opacity;3;0;Create;True;0;0;0;False;0;False;-1;bb88bee0f603d52449c53a1ab64d6e89;bb88bee0f603d52449c53a1ab64d6e89;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1014.5,99;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-710.5,-141;Inherit;True;Property;_T_M_Washing_2_Machine_AlbedoTransparency;T_M_Washing_2_Machine_AlbedoTransparency;0;0;Create;True;0;0;0;False;0;False;-1;40288f4aaf0886749957aac48b870363;40288f4aaf0886749957aac48b870363;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-702.5,72;Inherit;True;Property;_T_M_Washing_2_Machine_MetallicSmoothness;T_M_Washing_2_Machine_MetallicSmoothness;1;0;Create;True;0;0;0;False;0;False;-1;d5ea5879adf183a4cb5a7a231a84b271;d5ea5879adf183a4cb5a7a231a84b271;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;168,93;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Wahing_Machine;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638226262759649696;  Refraction Model;0;638226264314003703;  Blend;0;638226264420176440;Two Sided;0;638226264568414504;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;1;638226265019925785;Transmission;0;638226262626068481;  Transmission Shadow;0.87,False,;638226260267248160;Translucency;0;638226264171606780;  Translucency Strength;33.9,False,;638226264029968899;  Normal Distortion;0.5,False,;0;  Scattering;23.6,False,;638226264160756652;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;638226260968843937;  Use Shadow Threshold;0;638226260999415097;Receive Shadows;0;638226264230899346;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;False;True;True;False;;False;0
WireConnection;1;0;10;0
WireConnection;1;1;12;0
WireConnection;1;3;11;0
WireConnection;1;4;11;4
WireConnection;1;6;13;0
ASEEND*/
//CHKSM=3284290F4F74A19CB950FDD9A4C5B1594F8586BB